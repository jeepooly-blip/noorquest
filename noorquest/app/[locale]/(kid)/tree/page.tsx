...
export default async function TreePage({ params: { locale } }: { params: { locale: string } }) {
    ...
    <main className="mx-auto max-w-2xl p-8 text-center">
      ...
      <div className="mt-8 rounded-3xl bg-white p-8 shadow-md">
        ...
        <p className="mt-2 text-sm text-ink/50">
          See <a href="/prototypes/noor-tree.html" className="text-sky-600 underline">prototype</a> for the full interactive version.
        </p>
      </div>
    </main>
  );
